...
describe('insertion sort: a subarray', () => { 
    let nodes = [8, 3, 1, 6, 7, 11, 14, 9, 10, 12, 15];

    test('should return a sorted subarray', () => {
        let sorted = insertionSort2(nodes, 0, 5);
        ...
        // unsorted portion
        expect(sorted[6]).toBe(14);
        expect(sorted[7]).toBe(9);
        expect(sorted[8]).toBe(10);
